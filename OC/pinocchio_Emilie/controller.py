...
def pushup(up, q, qdot, dt):
    ...
    qa = q[7:]
    '''
    qa[0,0] = 1 # épaule gauche
    qa[1,0] = 1 # coude gauche
    qa[2,0] = 1 # épaule droite
    qa[3,0] = 1 # coude droit
    qa[4,0] = 1 # hanche gauche
    qa[5,0] = 1 # genoux gauche
    qa[6,0] = 1 # hanche droite
    qa[7,0] = 1 # genoux droit
    '''
    ...
    #######################
    # LEGS
    qa_ref[4,0] = 2*np.pi/5
    qa_ref[6,0] = 2*np.pi/5
    ...
    # DOWN
    down_shld = 3*np.pi/5
    down_elbow = -5*np.pi/6

    if up :
        # going up
        if abs(qa[1,0] - up_elbow) < 0.2 :
            # highest point reached
            qa_ref[0,0] = down_shld
            qa_ref[2,0] = down_shld
            qa_ref[1,0] = down_elbow
            qa_ref[3,0] = down_elbow
            # going down now
            up = False
        else:
            # still going up
